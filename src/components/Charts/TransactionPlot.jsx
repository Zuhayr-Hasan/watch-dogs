  ...
  return (
    <div className=" bg-[#333639] rounded-lg p-4 TransactionFont">
      <div className="flex justify-between">
        <h1 className="mt-2 text-xl text-white font-bold pl-5">
          NFT Transactions (Profit / Loss)
        </h1>
        <p className="mt-2 text-xs pr-5">
          <span className="text-white">3M</span>
          <span className="text-[#BDBBBB]">/6M/12M</span>
        </p>
      </div>
      <p className="mt-2 text-white font-semibold text-md pl-5 pt-2">Sales</p>
      <div>
        <div id="chart">
          <ReactApexChart
